...
if (isset($_POST['submit'])) {
    ...
    $sql = "select billno,dateordered,collectiondate,memberno,fullamount,deposit,balance,payment,simple,emboidery,manik,patching,diamond,tudung,repair,qty,cutter,sewer,beader,embpatch,status FROM masterfile2023 WHERE memberno = $memberno";
